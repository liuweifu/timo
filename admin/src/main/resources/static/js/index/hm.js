(function () {
    var h = {}, mt = {}, c = {
        id: "5d5bfadcd708563358f6600c01fdcfaf",
        dm: ["bjjcxzl.com"],
    ...
    (function () {
        var a = mt.f, b = mt.lang, g = h.A, d = h.ra, e = h.P, r = e.O;
    ...
    (function () {
        var a = mt.f, b = mt.event, g = mt.lang, d = h.z, e = h.ra, r = h.ta, f = h.P, l = f.O, n = {
    ...
    (function () {
        var a = mt.lang, b = mt.f, g = mt.event, d = mt.g, e = h.z, r = h.A, f = h.P, l = f.O, n = +new Date, p = [],
            s = {
                ba: function () {
                    return function (d) {
                    ...
                    h.c.b.et = 5;
                    h.c.b.ep = a;
                    h.c.b.p = l(f.B("autoEventTracking"));
                    h.c.i();
                    h.c.b.p = ""
                }, Z: function () {
                    return function () {
    ...
    (function () {
        var a = mt.lang, b = mt.event, g = mt.g, d = h.z, e = h.A, r = +new Date, f = [], l = w, n = {
            tb: function () {
    ...
    (function () {
        ...
        var e = mt.event, r = h.A, f = u, l = u, n = u, p = u, s = +new Date, t = s, v = 0, k = u,
    ...
    (function () {
        var a = mt.lang, b = h.z, g = h.load, d = {
            bc: function (d) {
    ...
    (function () {
        ...
        var g = mt.url, d = mt.lang, e = mt.s, r = mt.g, f = h.z, l = h.A, n = h.zb, p = h.load, s = h.qa, t = h.P,
            v = t.O, k = {
                Y: [], ha: 0, Da: x,
                D: {Ma: "", page: ""}, init: function () {
                    k.j = 0;
                    t.init();
                    l.e("pv-b", function () {
                        k.Ab();
                    ...
                    l.e("stag-b", function () {
                        ...
                        h.c.b.ct = [decodeURIComponent(s.getData("Hm_ct_" + c.id) || ""), k.D.Ma, k.D.page].join("!")
                    });
                    l.e("stag-d", function () {
                        h.c.b.api = 0;
                        k.j = 0;
                    ...
                    1 < a.length && (a[1].charAt && "/" === a[1].charAt(0)) && (k.j |= 4, h.c.b.sn = h.c.Va(), h.c.b.et = 0, h.c.b.ep = "", h.c.b.vl = r.U() + r.M(), h.c.b.kb = 0, h.c.Ba ? (h.c.b.nv = 0, h.c.b.st = 4) : h.c.Ba = u, k.Da || (h.c.b.su = h.c.b.u || document.location.href), h.c.b.u = f.protocol + "//" + document.location.host +
                        a[1], h.c.b.p = v(t.B("pageview")), h.c.i(), h.c.b.p = "", h.c.X = +new Date, t.o("pageview"))
                    ...
                    if (1 < a.length) {
                        ...
                        if (d.G(f.eb,
                            ...
                            var l = a[g][2] || {};
                            if (b.plugins[e] && !b.I[e]) b.I[e] = new b.plugins[e](l), b.C.shift(); else break
                        }
                    }
                    ...
                    if (1 < a.length) {
                        ...
                        if (d.G(f.eb, e)) if (b.plugins = b.plugins || {}, b.I = b.I || {}, b.plugins[e] && !b.I[e]) b.I[e] = new b.plugins[e](g); else {
                            b.C = b.C || [];
                            for (var g = 0, l = b.C.length; g < l; g++) if (b.C[g][1] ===
                                e) return;
                            b.C.push(a);
    ...
    (function () {
        ...
        var b = mt.url, g = mt.lb, d = mt.Ka, e = mt.lang, r = mt.cookie, f = mt.g, l = mt.sessionStorage, n = mt.s,
            p = mt.event, s = h.qa, t = h.P, v = t.O, k = h.z, m = h.load, y = h.A;
        a.prototype = {
            W: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                this.Xa ? (this.Ba = u, this.b.et = 0, this.b.ep = "", this.b.p = v(t.B("pageview")), this.b.vl = f.U() + f.M(), this.i(a), this.b.p = "") : a();
                this.X = +new Date;
                t.o("pageview")
            }, i: function (a) {
                if (this.Ya) {
